...
export class ArchiveProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing ArchiveProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/archive/2.4.0/docs#import import section} in the documentation of this resource for the id to use
